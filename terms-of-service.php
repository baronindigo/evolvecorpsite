...
<div class="wrapper">
	...
	<div class="terms-of-service">
		...
		<section>
			...
			<div>
				<p>This Agreement was last revised on January 10, 2021.</p>

				<p>Welcome to the Site, a website and online service owned and operated by Evolve Media, LLC (“Evolve”). Evolve, and any and all entities that control, are controlled by, or are affiliated or under common control with, Evolve are collectively referred to herein as “Company” “we,” “us” or “our”. This page explains the terms by which site visitors and members (“you”) may use our service. By accessing or using the Company services, Site and software provided through or in connection with the service (“Service”), you signify that you have read, understood, and agree to be bound by this Terms of Use Agreement (“Agreement”), the Company’s Privacy Policy, and any additional terms and conditions, notices and disclaimers displayed through the Service, whether or not you are a registered user of our Service.</p>

				<p>We reserve the right to amend this Agreement at any time and without notice. If we do this, we will post the amended Agreement on this page and indicate at the top of the page the date the Agreement was last revised. Your continued use of the Service after any such changes constitutes your acceptance of the new Terms of Use. If you do not agree to any of these terms or any future Terms of Use, do not use or access (or continue to access) the Service. This Agreement applies to all visitors, users, and others who access the Service (“Users”).</p>

				<h3>1. Eligibility</h3>
				<p>This Service is intended solely for Users who are thirteen (13) years of age or older, and any registration, use or access to the Service by anyone under 13 is unauthorized, unlicensed, and in violation of this Agreement.</p>

				<p>Company may terminate your account or profile, delete any content or information that you have posted on the Service, and/or prohibit you from using or accessing the Service (or any portion, aspect or feature of the Service) for any reason or no reason, at any time in its sole discretion, with or without notice, including without limitation if it believes that you are under 13. If you are a minor in the jurisdiction in which you reside (e.g. under 18 years of age), you may only use the Service if (a) you either are an emancipated minor or obtain parental or legal guardian consent after review of this Agreement prior to you using any of the Services provided by Company and (b) you are fully able and competent to enter into the terms, conditions, obligations, affirmations, representations, and warranties set forth in this Agreement, and to abide by and comply with this Agreement.</p>

				<h3>2. No Warranty</h3>
				<p>The service is provided on an “as is” and “as available” basis. Use of the service is at your own risk. To the maximum extent permitted by applicable law, the Service is provided without warranties of any kind, whether express or implied, including, but not limited to, implied warranties of merchantability, fitness for a particular purpose, or non-infringement.</p>

				<p>Without limiting the foregoing, to the maximum extent permitted by applicable law, Company, its subsidiaries, and its licensors do not warrant that the content is accurate, reliable or correct; that the service will meet your requirements; that the service will be available at any particular time or location, uninterrupted or secure; that any defects or errors will be corrected; or that the service is free of viruses or other harmful components.</p>
				...
				<p>To the maximum extent permitted by applicable law, Company does not warrant, endorse, guarantee, or assume responsibility for any product or service advertised or offered by a third party through the Company service or any hyperlinked website or service, or featured in any banner or other advertising, and Company will not be a party to or in any way monitor any transaction between you and third-party providers of products or services.</p>
				...
				<p>The Service is controlled and operated from facilities in the United States. Company makes no representations that the Service is appropriate or available for use in other locations. Those who access or use the Service from other jurisdictions do so at their own volition and are entirely responsible for compliance with local law, including but not limited to export and import regulations.</p>
				...
				<p>You may never use another Member’s account or profile without permission. When creating your account or profile, you must provide accurate and complete information. You are solely responsible for the activity that occurs on your account or profile, and you must keep your account or profile password secure. You must notify Company immediately of any breach offensive security or unauthorized use of your account or profile. Although Company will not be liable for your losses caused by any unauthorized use of your account or profile, you shall be liable for the losses of Company or others due to such unauthorized use.</p>

				<p>By providing Company your email address, you consent to our using the email address in accordance with our Privacy Policy.</p>
				...
				<p>Company takes no responsibility and assumes no liability for any User Content that you or any other Users or third parties post or send over the Service. You understand and agree that any loss or damage of any kind that occurs as a result of the use of any User Content that you send, upload, download, stream, post, transmit, display, or otherwise make available or access through your use of the Service, is solely your responsibility. Company is not responsible for any public display or misuse of your User Content.</p>

				<p>You understand and acknowledge that you may be exposed to User Content that is inaccurate, offensive, indecent, or objectionable, and you agree that Company shall not be liable for any damages you allege to incur as a result of such User Content. We reserve the right to monitor and review transmissions online and in storage, and to remove or reject any material, which we, at our sole discretion, believe may be unlawful or objectionable, without prior notice to User.</p>

				<h3>6. Chat Rooms</h3>
				<p>All Users who are minors in the jurisdiction in which they reside must have the permission of their parent or guardian to use the Site chat rooms. All minors must be directly supervised by their parent or guardian while using our chat rooms. Company does not systematically monitor and review the conversations that take place in the chat rooms. Company does not determine the true identity or age of those who frequent and use the Site chat rooms.</p>

				<h3>7. Opt Out</h3>
				<p>If the functionality of the Site permits, accounts or profiles may be deactivated by logging into the account or profile and visiting the Preferences page. You will then need to re-enter your password and click the confirm button at the bottom of the page. Your account or profile then may no longer be logged into or viewed, and all photos will be deleted. Account or profile deactivation is permanent and not reversible.</p>

				<h3>8. License Grant</h3>
				<p>By posting any User Content on the Service, you expressly grant, and you represent and warrant that you have a right to grant, to Company a royalty-free, sublicensable, transferable, perpetual, irrevocable, non-exclusive, worldwide license to use, reproduce, modify, publish, list information regarding, edit, translate, distribute, publicly perform, publicly display, and make derivative works of all such User Content and your name, voice, and/or likeness as contained in your User Content, in whole or in part, and in any form, media or technology, whether now known or hereafter developed for use in connection with the Service.</p>

				<h3>9. Our Proprietary Rights</h3>
				<p>Except for your User Content, the Service and all materials therein or transferred thereby, including, without limitation, software, images, text, graphics, illustrations, logos, patents, trademarks, service marks, copyrights, photographs, audio, videos, music, and User Content (the “Company Content”), and all Intellectual Property Rights related thereto, are the exclusive property of Company and its licensors.</p>
				...
				<p>You may choose to or we may invite you to submit comments or ideas about the Service, including without limitation about how to improve the Service or our products (“Ideas”). By submitting any Idea, you agree that your disclosure is gratuitous, unsolicited and without restriction and will not place Company under any fiduciary or other obligation, that we are free to disclose the Ideas on a non-confidential basis to anyone or otherwise use the Ideas without any additional compensation to you. You acknowledge that, by acceptance of your submission, Company does not waive any rights to use similar or related ideas previously known to Company, or developed by its employees, or obtained from sources other than you.</p>

				<h3>10. Privacy</h3>
				<p>We care about the privacy of our Users. Please see our posted Privacy Policy. By using the
				...
				Email: legal[at]evolvemediallc.com<br/>
				Phone: (310) 449-1890<br/>
				...
				<h3>13. Additional Representations and Warranties</h3>
				...
				party website from Company, you do so at your own risk, and you understand that this Agreement and Company’s Privacy Policy do not apply to your use of such sites. You expressly release Company from any and all liability arising from your use of any third-party website or services or third party owned content. Additionally, your dealings with or participation in promotions of advertisers found on Company, including payment and delivery of goods, and any other terms (such as warranties) are solely between you and such advertisers. You agree that Company shall not be responsible for any loss or damage of any sort relating to your dealings with such advertisers.</p>
				...
				<p> Company does not have any obligation to prescreen, edit, or remove any Content provided by Users that is posted on or available through the Site.</p>

				<p>Notwithstanding the foregoing, Company will have the right (but not the obligation), in its sole discretion and for any reason, to prescreen, edit, refuse to accept, remove, or move any such Content.</p>

				<p>THE CONTENT AVAILABLE VIA THE SITE IS PROVIDED WITH THE UNDERSTANDING THAT NEITHER COMPANY NOR ITS SUPPLIERS OR USERS ARE ENGAGED IN RENDERING MEDICAL, COUNSELING, LEGAL, OR OTHER PROFESSIONAL SERVICES OR ADVICE. SUCH CONTENT IS INTENDED SOLELY AS A GENERAL EDUCATIONAL AID. IT IS NOT INTENDED AS MEDICAL OR HEALTHCARE ADVICE OR COUNSELING, OR TO BE USED FOR MEDICAL DIAGNOSIS OR TREATMENT, FOR ANY INDIVIDUAL PROBLEM. IT IS ALSO NOT INTENDED AS A SUBSTITUTE FOR PROFESSIONAL ADVICE AND SERVICES FROM A QUALIFIED HEALTHCARE PROVIDER FAMILIAR WITH YOUR UNIQUE FACTS. ALWAYS SEEK THE ADVICE OF YOUR PHYSICIAN OR OTHER QUALIFIED HEALTHCARE PROVIDER REGARDING ANY MEDICAL CONDITION AND BEFORE STARTING ANY NEW TREATMENT.</p>

				<h3>17. Assignment</h3>
				<p>This Agreement, and any rights and licenses granted hereunder, may not be transferred or assigned by you, but may be assigned by Company without restriction.</p>
				...
				email notice, written or hard copy notice, or through conspicuous posting of such notice on the Site, as determined by Company in our sole discretion. Company reserves the right to determine the form and means of providing notifications to our Users, provided that you may opt out of certain means of notification as described in this Agreement.</p>

				<h3>22. Entire Agreement/Severability.</h3>
				<p>This Agreement, together with any other legal notices and agreements published by Company via the Service, shall constitute the entire agreement
				between you and Company concerning the Service. If any provision of this Agreement is deemed invalid by a court of competent jurisdiction, the invalidity of such provision shall not affect the validity of the remaining provisions of this Agreement, which shall remain in full force and effect.</p>
